...
sender = st.text_input("Input sender address")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
reciver = st.text_input("Input reciver address")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount = st.number_input("Input the transfer amount")
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record=Record(sender=sender, reciver=reciver, amount=amount),
        creator_id=42,
